...
<head>
    ...
    <script src="/static/vendor/trumbowyg.min.js"></script>
    <script src="/static/vendor/plugins/fontfamily/trumbowyg.fontfamily.min.js"></script>
    <script src="/static/vendor/plugins/fontsize/trumbowyg.fontsize.min.js"></script>
